...
class Templates extends Base {
	...
	public function get( $slug, $name = null, $args = [], $load = true ): string {
		...
		do_action( 'test_plugin_get_template_part_' . $slug, $slug, $name, $args );
	...
	protected function getFileNames( $slug, $name, $args ): array {
		 ...
		 *
		 */
		return apply_filters( 'test_plugin_get_template_part', $templates, $slug, $name, $args );
	}
	...
	protected function getPaths(): array {
		 ...
		 *
		 */
		$file_paths = apply_filters( 'test_plugin_template_paths', $file_paths );
